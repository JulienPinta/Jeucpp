...
void Plateau::moveLeoUp(Personnage Leo) {
	Leo.translate(0, -1);
}

void Plateau::moveLeoDown(Personnage Leo) {
	Leo.translate(0, 1);
}

void Plateau::moveLeoRight(Personnage Leo) {
	Leo.translate(1, 0);
}

void Plateau::moveLeoLeft(Personnage Leo) {
	Leo.translate(-1, 0);
}
...
void Plateau::ajouterPerso(Personnage Leo) {
	persos.push_back(Leo);
}
